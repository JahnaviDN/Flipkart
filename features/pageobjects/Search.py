...
class Search(BaseSettingsPage):
    ...
    def text_Searchbar(self, searchTEXT):
        WebDriverWait(self.driver, 40, ignored_exceptions=[StaleElementReferenceException]).until(
            EC.presence_of_element_located((By.XPATH, "/html/body/div[1]/div/div[1]/div[1]/div[2]/div[2]/form/div/div/input")))
    ...
    def minFun(self):
        ...
        drop = Select(self.driver.find_element(By.XPATH,
                                               "//*[@id='container']/div/div[3]/div/div[1]/div/div/div/section[2]/div[4]/div[1]/select"))
        drop.select_by_index(1)
        time.sleep(3)
        drop = Select(self.driver.find_element(By.XPATH,
                                               "//*[@id='container']/div/div[3]/div/div[1]/div/div/div/section[2]/div[4]/div[3]/select"))
        drop.select_by_index(1)
        time.sleep(3)
        # for i in drop:
        #     i.select_by_index("1")
    ...
    def Availability(self):
        ...
        self.driver.find_element(By.XPATH,"(//*[name()='svg'][@class='ttx38n'])[1]").click()
        time.sleep(10)
        self.driver.find_element(By.XPATH,"(//div[@class='_24_Dny'])[5]").click()
        time.sleep(20)

    def language(self):
        self.driver.find_element(By.XPATH,"(//div[@class='_24_Dny'])[5]").click()
        time.sleep(3)
        self.driver.find_element(By.XPATH,"(//div[@class='_24_Dny'])[6]").click()
        time.sleep(20)
